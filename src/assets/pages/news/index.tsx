                ...
                <div className="container">
                    <div className="row">
                        <div id="siteRelease" className="col-md-12 mb-5">
                            ...
                            Foi desenvolvido pelo aluno Gustaf (ou Gustavo) Toledo e sua companheira Eloize Rodrigues Xavier com ajuda dos colegas Vitor Santos e Ricardo Gomes, e juntamente o apoio do Coordenador do Curso, Milton Brito. </p>
